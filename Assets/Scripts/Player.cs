...
public class Player : MonoBehaviour
{
    ...
    public void RotateForward(Vector3 torqueAxis)
    {
        _rigidbody.AddTorque(torqueAxis * _rotationSpeed, ForceMode.VelocityChange);
    }

    public void RotateBackward(Vector3 torqueAxis)
    {
        _rigidbody.AddTorque(torqueAxis * _rotationSpeed, ForceMode.VelocityChange);
    }

    public void RotateLeft(Vector3 torqueAxis)
    {
        _rigidbody.AddTorque(torqueAxis * _rotationSpeed, ForceMode.VelocityChange);
    }

    public void RotateRight(Vector3 torqueAxis)
    {
        _rigidbody.AddTorque(torqueAxis * _rotationSpeed, ForceMode.VelocityChange);
    }
}
